...
Ex1<-function()
{
  Streams <- read.table("D:\\Courses\\FISH 559_18\\HOMES\\AHOME1\\HOME1A.TXT",sep="") 
...
Ex2<-function()
{
  ...
  TheData<-scan("D:\\Courses\\FISH 559_18\\HOMES\\AHOME1\\Home1b.txt",what=list(SSB=0,Rec=0,Spec2=0,SBPR=0),skip=1,n=4*294)   
