...
DoMCMCAll <- function(model,VarCo)
 {  
  ...
  xx <- seq(1,Nrow)
  par(mfrow=c(2,2))
  plot(xx,exp(post2[,1]),xlab="Cycle number",ylab="Parameter 1",pch=16)
  plot(xx,exp(post2[,2]),xlab="Cycle number",ylab="Parameter 2",pch=16)
  plot(xx,exp(post2[,3]),xlab="Cycle number",ylab="Parameter 3",pch=16)
...
setwd("C:\\Users\\jysullivan\\Documents\\uw-fish559\\tmb-workshop-fhl\\Day3\\")
